...
public class SanPhamDaBan extends HangHoa {
	...
	public SanPhamDaBan(String maSanPham, String tenSanPham, String nhaSanXuat, int soLuong, double giaBan,LocalDate ngaySanXuat, LocalDate hanSuDung, LocalDateTime ngayBanHang) {
